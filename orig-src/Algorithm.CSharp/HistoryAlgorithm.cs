    ...
    public class HistoryAlgorithm : QCAlgorithm
    {
        ...
        */
        public @Override void Initialize() {
            ...
            tradeBarHistory = History( "SPY", Duration.ofDays(365));
            AssertHistoryCount( "History(\"SPY\", Duration.ofDays(365))", tradeBarHistory, 250);

            // get the last calendar day's worth of SPY data at the specified resolution
            tradeBarHistory = History( "SPY", Duration.ofDays(1), Resolution.Minute);
            AssertHistoryCount( "History(\"SPY\", Duration.ofDays(1), Resolution.Minute)", tradeBarHistory, 390);
            ...
            quandlHistory = History<Quandl>( "YAHOO/INDEX_SPY", Duration.ofDays(365));
            AssertHistoryCount( "History<Quandl>(\"YAHOO/INDEX_SPY\", Duration.ofDays(365))", quandlHistory, 250);
            ...
            allQuandlData = History<Quandl>(Duration.ofDays(365));
            AssertHistoryCount( "History<Quandl>(Duration.ofDays(365))", allQuandlData, 250);
            ...
            //quandlHistory = History<Quandl>( "YAHOO/INDEX_SPY", Duration.ofDays(7), Resolution.Minute);
            //quandlHistory = History<Quandl>( "YAHOO/INDEX_SPY", 14, Resolution.Minute);
            //allQuandlData = History<Quandl>(Duration.ofDays(365), Resolution.Minute);
            //allQuandlData = History<Quandl>(Securities.Keys, 14, Resolution.Minute);
            //allQuandlData = History<Quandl>(Securities.Keys, Duration.ofDays(1), Resolution.Minute);
            //allQuandlData = History<Quandl>(Securities.Keys, 14, Resolution.Minute);

            // get the last calendar year's worth of all quandl data
            allQuandlData = History<Quandl>(Securities.Keys, Duration.ofDays(365));
            AssertHistoryCount( "History<Quandl>(Securities.Keys, Duration.ofDays(365))", allQuandlData, 250);
            ...
            singleSymbolQuandl = allQuandlData.Get( "YAHOO/INDEX_SPY");
            ...
            allHistory = History(Duration.ofDays(365));
            AssertHistoryCount( "History(Duration.ofDays(365))", allHistory, 250);

            // request the last days's worth of history at the minute resolution
            allHistory = History(Duration.ofDays(1), Resolution.Minute);
            AssertHistoryCount( "History(Duration.ofDays(1), Resolution.Minute)", allHistory, 391);
            ...
            allHistory = History(Securities.Keys, Duration.ofDays(365));
            AssertHistoryCount( "History(Securities.Keys, Duration.ofDays(365))", allHistory, 250);
            // we can also specify the resolutin
            allHistory = History(Securities.Keys, Duration.ofDays(1), Resolution.Minute);
            AssertHistoryCount( "History(Securities.Keys, Duration.ofDays(1), Resolution.Minute)", allHistory, 391);
