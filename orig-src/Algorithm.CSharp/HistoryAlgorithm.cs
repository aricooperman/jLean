...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class HistoryAlgorithm : QCAlgorithm
    {
        ...
        public override void Initialize()
        {
            ...
            tradeBarHistory = History("SPY", TimeSpan.FromDays(365));
            ...
            quandlHistory = History<Quandl>("YAHOO/INDEX_SPY", TimeSpan.FromDays(365));
            ...
            allQuandlData = History<Quandl>(TimeSpan.FromDays(365));
            ...
            allHistory = History(TimeSpan.FromDays(365));
