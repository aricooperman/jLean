...
namespace QuantConnect 
{
    ...
    public class Chart 
    {
        ...
        public Chart GetUpdates() 
        {
            ...
            try
            {   
                foreach (series in Series.Values)
                {
    ...
    public class Series
    {
        ...
        public void AddPoint(DateTime time, BigDecimal value, boolean liveMode = false)
        {
            ...
            chartPoint = new ChartPoint(time, value);
        ...
        {
            copy = new Series(Name, SeriesType, Index, Unit)
            {
                Color = Color,
            ...
            try
            {
                ...
                for (i = _updatePosition; i < Values.Count; i++)
                {
    ...
    public struct ChartPoint
    {
        ...
        public ChartPoint(DateTime time, BigDecimal value) 
        {
