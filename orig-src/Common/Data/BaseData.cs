...
package com.quantconnect.lean.Data
{
    ...
    public abstract class BaseData : IBaseData
    {
        ...
        private boolean _isFillForward;
        ...
        public virtual BaseData Reader(SubscriptionDataConfig config, String line, DateTime date, boolean isLiveMode)
        {
            // stub implementation to prevent compile errors in user algorithms
            dataFeed = isLiveMode ? DataFeedEndpoint.LiveTrading : DataFeedEndpoint.Backtesting;
...
#pragma warning restore 618
        ...
        public virtual SubscriptionDataSource GetSource(SubscriptionDataConfig config, DateTime date, boolean isLiveMode)
        {
            // stub implementation to prevent compile errors in user algorithms
            dataFeed = isLiveMode ? DataFeedEndpoint.LiveTrading : DataFeedEndpoint.Backtesting;
#pragma warning disable 618 // This implementation is left here for backwards compatibility of the BaseData API
            source = GetSource(config, date, dataFeed);
#pragma warning restore 618
        ...
        public void UpdateQuote(decimal bidPrice, long bidSize, BigDecimal askPrice, long askSize)
        {
        ...
        public virtual void Update(decimal lastTrade, BigDecimal bidPrice, BigDecimal askPrice, BigDecimal volume, BigDecimal bidSize, BigDecimal askSize)
        {
            Value = lastTrade;
        }
