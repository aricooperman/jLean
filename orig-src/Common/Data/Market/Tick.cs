...
namespace QuantConnect.Data.Market
{
    ...
    public class Tick : BaseData
    {
        ...
        public BigDecimal BidPrice = 0;

        /// <summary>
        /// Asking price for the Tick quote.
        /// </summary>
        /// <remarks>QuantConnect does not currently have quote data but was designed to handle ticks and quotes</remarks>
        public BigDecimal AskPrice = 0;
        ...
        public Tick(DateTime time, Symbol symbol, BigDecimal bid, BigDecimal ask)
        {
            DataType = MarketDataType.Tick;
            Time = time;
            Symbol = symbol;
        ...
        public Tick(DateTime time, Symbol symbol, BigDecimal last, BigDecimal bid, BigDecimal ask)
        {
            DataType = MarketDataType.Tick;
            Time = time;
            Symbol = symbol;
