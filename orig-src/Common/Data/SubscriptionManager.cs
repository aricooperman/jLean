...
package com.quantconnect.lean.Data
{
    ...
    public class SubscriptionManager
    {
        ...
        public SubscriptionDataConfig Add(Symbol symbol, Resolution resolution, DateTimeZone timeZone, DateTimeZone exchangeTimeZone, boolean isCustomData = false, boolean fillDataForward = true, boolean extendedMarketHours = false)
        {
        ...
        /// <returns>The newly created <see cref="SubscriptionDataConfig"/></returns>
        public SubscriptionDataConfig Add(Type dataType, Symbol symbol, Resolution resolution, DateTimeZone dataTimeZone, DateTimeZone exchangeTimeZone, boolean isCustomData, boolean fillDataForward = true, boolean extendedMarketHours = false, boolean isInternalFeed = false, boolean isFilteredSubscription = true)
        {
            ...
            //Create:
            newConfig = new SubscriptionDataConfig(dataType, symbol, resolution, dataTimeZone, exchangeTimeZone, fillDataForward, extendedMarketHours, isInternalFeed, isCustomData, isFilteredSubscription: isFilteredSubscription);
