...
namespace QuantConnect.Packets
{
    ...
    public class BacktestResultPacket : Packet 
    {
            ...
            : base (PacketType.BacktestResult)
        {
            try
            {
                packet = JsonConvert.DeserializeObject<BacktestResultPacket>(json, new JsonSerializerSettings
                {
        ...
        public BacktestResultPacket(BacktestNodePacket job, BacktestResult results, BigDecimal progress = 1m)
            : base(PacketType.BacktestResult)
        {
            try
            {
