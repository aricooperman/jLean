...
package com.quantconnect.lean.Indicators
{
    ...
    */
    ...
    {
        private static final BigDecimal ConstMax = 2m / (30m + 1m);
        private static final BigDecimal ConstDiff = 2m / (2m + 1m) - ConstMax;

        private BigDecimal _sumRoc1;
        private BigDecimal _periodRoc;
        private BigDecimal _prevKama;
        ...
        */
        ...
        protected @Override BigDecimal ComputeNextValue(IReadOnlyWindow<IndicatorDataPoint> window, IndicatorDataPoint input) {
            ...
            efficiencyRatio = (_sumRoc1 <= _periodRoc) || _sumRoc1 == 0 ? 1m : Math.Abs(_periodRoc / _sumRoc1);

            // Calculate the smoothing constant
            smoothingConstant = efficiencyRatio * ConstDiff + ConstMax;
