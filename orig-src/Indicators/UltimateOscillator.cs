...
package com.quantconnect.lean.Indicators
{
    ...
    public class UltimateOscillator : TradeBarIndicator
    {
        ...
        protected override BigDecimal ComputeNextValue(TradeBar input)
        {
            ...
            buyingPressure = new IndicatorDataPoint { Value = input.Close - Math.Min(input.Low, _previousInput.Close) };
            ...
            average2 = _sumBuyingPressure2 / _sumTrueRange2;
            average3 = _sumBuyingPressure3 / _sumTrueRange3;
