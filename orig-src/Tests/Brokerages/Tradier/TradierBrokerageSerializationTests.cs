...
namespace QuantConnect.Tests.Brokerages.Tradier
{
    ...
    public class TradierBrokerageSerializationTests
    {
        ...
        'class':'equity'
            ...
            orders = JsonConvert.DeserializeObject<TradierOrdersContainer>(rawResponse);

            static final String rawNullResponse = @"{'orders': null }";
            orders = JsonConvert.DeserializeObject<TradierOrdersContainer>(rawNullResponse);

            static final String rawNullResponse2 = @"{'orders': 'null' }";
