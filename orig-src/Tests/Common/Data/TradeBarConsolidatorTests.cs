...
package com.quantconnect.lean.Tests.Common.Data
{
    ...
    public class TradeBarConsolidatorTests
    {
        ...
        public void ZeroCountAlwaysFires() {
            ...
            consolidator = new TradeBarConsolidator(0);
        ...
        public void OneCountAlwaysFires() {
            ...
            TradeBar consolidated = null;
            consolidator = new TradeBarConsolidator(1);
            consolidator.DataConsolidated += (sender, bar) =>
            {
                consolidated = bar;
            };
        ...
        public void ZeroSpanAlwaysFires() {
            ...
            reference = new DateTime(2014, 12, 01, 01, 01, 00);
        ...
        public void ConsolidatesOHLCV() {
            ...
            TradeBar consolidated = null;
            consolidator = new TradeBarConsolidator(3);
            consolidator.DataConsolidated += (sender, bar) =>
            {
                consolidated = bar;
            };
        ...
        public void ConsolidatedTimeIsFromBeginningOfBar() {
            ...
            reference = new DateTime(2014, 12, 1, 10, 00, 0);
