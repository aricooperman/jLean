...
namespace QuantConnect.Tests.Common.Orders.Fills
{
    ...
    public class PartialMarketFillModelTests
    {
        ...
        public void CreatesSpecificNumberOfFills()
        {
            ...
            referenceTimeUtc = InitializeTest(out algorithm, out security, out model, out order, out ticket);

            algorithm.SetDateTime(referenceTimeUtc.AddSeconds(1));

            fill1 = model.MarketFill(security, order);
            ...
            fill2 = model.MarketFill(security, order);
        ...
        public void RequiresAdvancingTime()
        {
            ...
            fill3 = model.MarketFill(security, order);
        ...
        private static DateTime InitializeTest(out BasicTemplateAlgorithm algorithm, out Security security, out PartialMarketFillModel model, out MarketOrder order, out OrderTicket ticket)
        {
            ...
            config = new SubscriptionDataConfig(typeof(TradeBar), Symbols.SPY, Resolution.Second, TimeZones.NewYork, TimeZones.NewYork, false, false, false);
        ...
        public class PartialMarketFillModel : ImmediateFillModel
        {
            ...
            public override OrderEvent MarketFill(Security asset, MarketOrder order)
            {
                ...
                remaining = (int)(ticket.Quantity - ticket.QuantityFilled);
                fill = base.MarketFill(asset, order);
                filledThisTime = Math.Min(remaining, (int)(_percent * order.Quantity));
