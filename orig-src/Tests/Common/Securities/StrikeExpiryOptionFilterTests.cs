...
package com.quantconnect.lean.Tests.Common.Securities
{
    ...
    public class StrikeExpiryOptionFilterTests
    {
        ...
        public void FiltersStrikeRange()
        {
            ...
            filtered = filter.Filter(symbols, underlying).ToList();
        ...
        public void FiltersExpiryRange()
        {
            ...
            underlying = new Tick { Value = 10m, Time = time };
            filter = new StrikeExpiryOptionFilter(0, 0, TimeSpan.FromDays(3), TimeSpan.FromDays(7));
            symbols = new[]
            {
