...
package com.quantconnect.lean.Tests.Engine.BrokerageTransactionHandlerTests
{
    ...
    {
        private static final String Ticker = "EURUSD";
        ...
        public void OrderQuantityIsFlooredToNearestMultipleOfLotSizeWhenLongOrderIsRounded() {
            ...
            // Creates the order
            security = _algorithm.Securities[Ticker];
            orderRequest = new SubmitOrderRequest(OrderType.Market, security.Type, security.Symbol, 1600, 0, 0, DateTime.Now, "");
        ...
        public void OrderIsNotPlacedWhenOrderIsLowerThanLotSize() {
            ...
            // Creates the order
            security = _algorithm.Securities[Ticker];
            orderRequest = new SubmitOrderRequest(OrderType.Market, security.Type, security.Symbol, 600, 0, 0, DateTime.Now, "");
