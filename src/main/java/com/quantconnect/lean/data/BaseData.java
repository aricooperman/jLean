...
public abstract class BaseData implements IBaseData {
    ...
    public SubscriptionDataSource getSource( SubscriptionDataConfig config, LocalDateTime date, boolean isLiveMode ) {
        // stub implementation to prevent compile errors in user algorithms
        final DataFeedEndpoint dataFeed = isLiveMode ? DataFeedEndpoint.LiveTrading : DataFeedEndpoint.Backtesting;
        String source = getSource( config, date, dataFeed );
    ...
    public void updateTrade( BigDecimal lastTrade, long tradeSize ) {
        update( lastTrade, BigDecimal.ZERO, BigDecimal.ZERO, tradeSize, 0, 0 );
    }
    ...
    public void updateQuote( BigDecimal bidPrice, long bidSize, BigDecimal askPrice, long askSize ) {
        update( BigDecimal.ZERO, bidPrice, askPrice, 0, bidSize, askSize );
    }
    ...
    public void updateBid( BigDecimal bidPrice, long bidSize ) {
        update( BigDecimal.ZERO, bidPrice, BigDecimal.ZERO, 0, bidSize, 0 );
    }
    ...
    public void updateAsk( BigDecimal askPrice, long askSize ) {
        update( BigDecimal.ZERO, BigDecimal.ZERO, askPrice, 0, 0, askSize );
    }
    ...
    public void update( BigDecimal lastTrade, BigDecimal bidPrice, BigDecimal askPrice, long volume, long bidSize, long askSize ) {
        value = lastTrade;
    }
