...
*/
public class MarketOnOpenOrder extends Order {
     ...
     */
    public MarketOnOpenOrder( Symbol symbol, int quantity, LocalDateTime time ) {
     ...
     */
    public MarketOnOpenOrder( Symbol symbol, int quantity, LocalDateTime time, String tag ) {
    ...
    @Override
    public Order clone() {
        final MarketOnOpenOrder order = new MarketOnOpenOrder();
        copyTo( order );
        return order;
    }
}
