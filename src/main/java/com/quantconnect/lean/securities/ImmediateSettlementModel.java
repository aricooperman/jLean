 ...
 */
public class ImmediateSettlementModel implements ISettlementModel {
     ...
     */
    public void applyFunds( SecurityPortfolioManager portfolio, Security security, LocalDateTime applicationTimeUtc, String currency, BigDecimal amount ) {
        portfolio.getCashBook().get( currency ).addAmount( amount );
    }
}
