...
public class SecurityExchangeHours {
     ...
     */    
    public ImmutableMap<DayOfWeek, LocalMarketHours> MarketHours
    {
    ...
    */
    ...
    public SecurityExchangeHours(ZoneId timeZone, IEnumerable<DateTime> holidayDates, ImmutableMap<DayOfWeek, LocalMarketHours> marketHoursForEachDayOfWeek) {
        _timeZone = timeZone;
